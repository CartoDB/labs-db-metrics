### 1. Introduce CARTO credentials

CARTO_USER = 'CARTO_USER'
CARTO_ORG = 'CARTO_ORG'
USER_QUOTA = 500 ##mb
CARTO_API_URL = 'https://CARTO_USER.carto.com'
CARTO_API_KEY = 'API_KEY'

### 2. Install and import all necessary libraries
...
### 3. Logger, variables and CARTO clients
...
### 4. Donwload datasets/maps information
...
### 6. Get Data Service quota information
...
#https://carto.com/developers/python-sdk/examples/#example-list-tables
...
### 8. Prepare template and report variables
